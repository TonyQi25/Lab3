...
public class Main {
    ...
    private static String promptForLanguage(Translator translator, String country) {
        ...
        // TODO Task: replace the line below so that we sort the languages alphabetically and
